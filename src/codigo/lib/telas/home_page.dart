...
import 'superusuario_login_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _submeterAuth() async {
    ...
    try {
      ...
      if (_tipoUsuario == 'empresa') {
        // Idempotente: só cria o documento de assinatura na primeira vez
        // (cadastro novo ou login de uma conta que ainda não tinha).
        await widget.empresaRepo.garantirEmpresa(uid, 'Minha Empresa', email);
      }
  ...
  void _abrirAcessoSuperusuario() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SuperusuarioLoginPage(
          ...
          Positioned(
            ...
            child: ClipPath(
              ...
              child: Container(
                ...
                child: _buildBackgroundPattern(size.width, size.height * 0.45, isTop: true, color: theme.colorScheme.onPrimary),
              ),
            ),
          ),
                                ...
                                child: Text(
                                    ...
                                    style: GoogleFonts.nunito(
                                        textStyle: theme.textTheme.displayLarge?.copyWith(
                                            color: theme.colorScheme.onPrimary, fontWeight: FontWeight.w900, fontSize: 70, height: 0.9, letterSpacing: -2.0
                                        )
                                    )
                                ),
                              ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              onPressed: _abrirAcessoSuperusuario,
                              style: TextButton.styleFrom(foregroundColor: Colors.grey[500]),
                              child: const Text('Outros', style: TextStyle(fontSize: 13)),
                            ),
                          ],
                        ),
                      ),
