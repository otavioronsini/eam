...
class _EmpresaDetalhePageState extends State<EmpresaDetalhePage> {
  ...
  void initState() {
    ...
    _pontosController = TextEditingController(
      text: _est.pontosPorVisita.toString(),
    );
  ...
  Future<void> _carregarRecompensas() async {
    ...
    final recs = await widget.estabelecimentoRepo
        .getRecompensasByEstabelecimento(_est.id!);
    if (!mounted) return;
  ...
  Future<void> _carregarPedidos() async {
    ...
    final pedidos = await widget.estabelecimentoRepo
        .getPedidosByEstabelecimento(_est.id!);
    if (!mounted) return;
    setState(() {
      _pedidos = pedidos;
  ...
  void _abrirGeradorDeQrCode() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GerarQrCodePage(
          estabelecimentoRepo: widget.estabelecimentoRepo,
          estabelecimentos: [_est],
          estabelecimentoInicialId: _est.id,
        ),
      ),
    );
  }
  ...
  void _editarEstabelecimento() async {
    ...
    if (_est.id == null) return;
    final atualizado = await widget.estabelecimentoRepo.getEstabelecimento(
      _est.id!,
    );
    if (!mounted) return;
    if (atualizado != null) {
            ...
            children: [
              ...
              if (_est.fotoPath != null)
                ListTile(
                  ...
                  onTap: () async {
                    Navigator.pop(context);
                    final updated = _est.copyWith(fotoPath: null);
                    setState(() => _est = updated);
                    await widget.estabelecimentoRepo.updateEstabelecimento(
                      _est,
                    );
                  },
                ),
  ...
  void _adicionarRecompensa() async {
    ...
    await widget.estabelecimentoRepo.insertRecompensa(
      Recompensa(
        estabelecimentoId: _est.id!,
        nome: result['nome'] as String,
        descricao: result['descricao'] as String,
        pontosNecessarios: result['pontos'] as int,
      ),
    );
    _carregarRecompensas();
  }
  ...
  Future<Map<String, dynamic>?> _mostrarDialogRecompensa(
    Recompensa? rec,
  ) async {
    ...
    final pontosController = TextEditingController(
      text: rec?.pontosNecessarios.toString() ?? '',
    );
    ...
    return showDialog<Map<String, dynamic>>(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          title: Text(
            rec == null ? 'Adicionar recompensa' : 'Editar recompensa',
          ),
          content: Form(
            key: formKey,
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(context, {
                  ...
                  'pontos': int.parse(pontosController.text.trim()),
                });
              },
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _editarEstabelecimento,
          ),
        ],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'Toque para adicionar ou trocar a foto',
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '${_est.latitude.toStringAsFixed(6)}, ${_est.longitude.toStringAsFixed(6)}',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Defina quantos pontos o cliente ganha por visita',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Recompensas que os clientes podem resgatar com os pontos',
                    style: TextStyle(color: Colors.grey[500], fontSize: 13),
                  ),
                  const SizedBox(height: 16),
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => _editarRecompensa(rec),
                            ),
                            IconButton(
                              icon: const Icon(
                              ...
                              onPressed: () => _removerRecompensa(rec),
                            ),
                          ],
                        ),
                      ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Toda vez que um cliente resgata pontos por uma recompensa, '
                    'o pedido aparece aqui com o e-mail de quem comprou',
                    style: TextStyle(color: Colors.grey[500], fontSize: 13),
                  ),
                  const SizedBox(height: 16),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Gere um QR Code de uso único: cada código vale para\n'
                    'apenas 1 cliente e você escolhe quantos pontos ele dá',
