...
class _CadastraEmpresaPageState extends State<CadastraEmpresaPage> {
  ...
  Future<void> _salvar() async {
    ...
    try {
      if (_editando) {
        ...
        await widget.estabelecimentoRepo.insertEstabelecimento(
          estabelecimento,
        );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Erro ao salvar estabelecimento: $e'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          _editando ? 'Editar estabelecimento' : 'Cadastrar estabelecimento',
